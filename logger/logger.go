...
var HttpServiceLog *logrus.Entry
var UtilLog *logrus.Entry
var PingLog *logrus.Entry
var DashLog *logrus.Entry
...
func init() {
	...
	selfLogHook, err := logger_util.NewFileHook(logger_conf.NfLogDir+"ran.log", os.O_CREATE|os.O_APPEND|os.O_RDWR, 0666)
	if err == nil {
	...
	HttpServiceLog = log.WithFields(logrus.Fields{"RAN": "HTTP Service"})
	UtilLog = log.WithFields(logrus.Fields{"RAN": "Util"})
	PingLog = log.WithFields(logrus.Fields{"RAN": "Ping Service"})
	DashLog = log.WithFields(logrus.Fields{"RAN": "MPEG-DASH Service"})
}
